...
export function Layout() {
  ...
  return (
    <div className="h-dvh min-h-dvh overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      ...
      <div
        className={cn(
          'flex h-dvh min-h-0 w-full flex-col overflow-hidden transition-[margin] duration-300 ease-in-out',
      ...
      >
        ...
        */}
        ...
        >
          <div
            className={cn(
              'animate-fadeIn flex min-h-0 flex-1 flex-col overflow-hidden bg-slate-950',
          ...
          >
            ...
            <main
              className={cn(
                'flex min-h-0 flex-1 flex-col overflow-hidden px-2 pt-0.5 sm:px-3 md:px-4',
