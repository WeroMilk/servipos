...
/**
 * Rasteriza un documento HTML completo (p. ej. `buildLetterDocumentHtml`) a PDF carta,
 * mismo enfoque que `exportInvoiceCfdiToPdf`.
 */
export async function exportLetterHtmlToPdf(html: string, fileBaseName: string): Promise<void> {
