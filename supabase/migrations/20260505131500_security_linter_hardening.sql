...
revoke all on function public.user_sucursal_id() from public;
grant execute on function public.user_sucursal_id() to authenticated, service_role;

revoke all on function public.can_access_sucursal(uuid, text) from public;
...
revoke all on function public.rpc_adjust_stock(text, text, numeric, text, text, text, text, jsonb) from public;
...
revoke all on function public.rpc_allocate_invoice_folio(text) from public;
grant execute on function public.rpc_allocate_invoice_folio(text) to authenticated, service_role;

revoke all on function public.rpc_cancel_sale(text, text, text, text) from public;
grant execute on function public.rpc_cancel_sale(text, text, text, text) to authenticated, service_role;

revoke all on function public.rpc_close_caja_session(text, text, numeric, text, text, text, numeric, int, numeric) from public;
...
revoke all on function public.rpc_confirm_incoming_transfer(text, text, text, text, jsonb) from public;
grant execute on function public.rpc_confirm_incoming_transfer(text, text, text, text, jsonb) to authenticated, service_role;

revoke all on function public.rpc_create_sale(text, text, jsonb) from public;
grant execute on function public.rpc_create_sale(text, text, jsonb) to authenticated, service_role;

revoke all on function public.rpc_increment_folio_actual_only(text) from public;
grant execute on function public.rpc_increment_folio_actual_only(text) to authenticated, service_role;

revoke all on function public.rpc_open_caja_session(text, numeric, text, text) from public;
grant execute on function public.rpc_open_caja_session(text, numeric, text, text) to authenticated, service_role;

revoke all on function public.rpc_registrar_aporte_caja(text, text, numeric, text, text, text) from public;
...
revoke all on function public.rpc_registrar_retiro_caja(text, text, numeric, text, text, text) from public;
...
revoke all on function public.rpc_reserve_prueba_factura_folio(text) from public;
grant execute on function public.rpc_reserve_prueba_factura_folio(text) to authenticated, service_role;

revoke all on function public.rpc_reserve_prueba_nomina_folio(text) from public;
grant execute on function public.rpc_reserve_prueba_nomina_folio(text) to authenticated, service_role;

revoke all on function public.rpc_update_pending_open_sale(text, text, jsonb) from public;
grant execute on function public.rpc_update_pending_open_sale(text, text, jsonb) to authenticated, service_role;

revoke all on function public.rpc_partial_return_sale(text, text, text, jsonb) from public;
